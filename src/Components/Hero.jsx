...
export default function Hero() {
  return (
    <div className='bg-transparent' >
      ...
      <div className='hero-title flex flex-col border-r-[10px] border-x-[#0D4C72] w-[330px] md:w-[500px] text-right pr-2 absolute top-[60%] right-[5%] font-semibold font-Josefin gap-y-4'>
