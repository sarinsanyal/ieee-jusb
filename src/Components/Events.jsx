...
export default function Events() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 w-4/5 mx-auto py-20">
      <div className="card relative w-[90%] h-[44rem] border-2 rounded-2xl overflow-hidden shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]">
        <div className="image_container w-full overflow-hidden rounded-bl-[20%] rounded-br-[50%]">
          <img
            src="../../events/helloieee.webp"
      ...
      <div className="card relative w-[90%] h-[44rem] border-2 rounded-2xl overflow-hidden shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]">
        ...
        <div className="w-[96%] min-h-fit px-4 flex flex-col gap-4 pt-4">
          ...
          <Link
            to={"https://ieee-jaduniv.in/hello-IEEE/"}
            target="_blank"
            className="absolute bottom-12 text-black bg-cyan-500 rounded-md hover:bg-cyan-700 duration-200 mx-auto mb-4 px-6 py-3 font-Josefin font-semibold text-lg"
          >
            Website
          </Link>
        </div>
      ...
      <div className="card relative w-[90%] h-[44rem] border-2 rounded-2xl overflow-hidden shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]">
        ...
        <div className="w-[96%] min-h-fit px-4 flex flex-col gap-4 pt-4">
          ...
          <hr className="relative border-slate-700 border-2" />
          <p className="relative font-Josefin text-lg">
            Projection is an one-on-one mentorship research program for 2nd year
            and 3rd year undergraduate students led by multiple experts across
            industries.
          </p>
          <Link
      ...
      <div className="card relative w-[90%] h-[44rem] border-2 rounded-2xl overflow-hidden shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]">
        ...
        <div className="w-[96%] min-h-fit px-4 flex flex-col gap-4 pt-4">
          ...
          <hr className="relative border-slate-700 border-2" />
          <p className="relative font-Josefin text-lg">
            ElevateX is an all-in-one mentoring session by IEEE JU SB members.
            Be it research or industry, be it competitive coding, electronics or
            soft skill development, we have tracks tailor-made for your needs,
            complete with doubt-clearing, quick contests, real-world problems
            and webinars by field experts.
          </p>
          <Link
      ...
      <div className="card relative w-[90%] h-[44rem] border-2 rounded-2xl overflow-hidden shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]">
        ...
        <div className="w-[96%] min-h-fit px-4 flex flex-col gap-4 pt-4">
          ...
          <hr className="relative border-slate-700 border-2" />
          <p className="relative font-Josefin text-lg">
            TechX Congress is the Eastern Indian Techno-Management Leadership
            Summit hosted by the IEEE computer society SYP MGAB in collaboration
            with two of India’s premier IEEE student chapters - Jadavpur
            University and NIT Durgapur
          </p>
          <Link
      ...
      <div className="card relative w-[90%] h-[44rem] border-2 rounded-2xl overflow-hidden shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]">
        ...
        <div className="w-[96%] min-h-fit px-4 flex flex-col gap-4 pt-4">
          <p className="relative font-Inclusive text-4xl">
            ML Accelerator Summit
          </p>
          <hr className="relative border-slate-700 border-2" />
          <p className="relative font-Josefin text-lg">
            The Machine Learning Accelerator Summit is a tiny step to help
            students, engineers and tech enthusiasts live the AI dream.
          </p>
          <Link
      ...
      <div className="card relative w-[90%] h-[44rem] border-2 rounded-2xl overflow-hidden shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]">
        ...
        <div className="w-[96%] min-h-fit px-4 flex flex-col gap-4 pt-4">
          ...
          <hr className="relative border-slate-700 border-2" />
          <p className="relative font-Josefin text-lg">
            Rewired 1.0 conducted by the IEEE Jadavpur University Student Branch
            was a Hands-on workshop mainly focused to attract students to learn
            about the intricacies of Electronics. It was mainly focused to
            attract students to learn Electronics and understand the practical
            aspects of it.
          </p>
          <Link
            to={
              "https://www.facebook.com/379102212921998/posts/487814142050804/?sfnsn=wiwspwa&extid=RNLRXMv5ShbE6f7Y"
            }
            target="_blank"
            className="absolute bottom-12 text-black bg-cyan-500 rounded-md hover:bg-cyan-700 duration-200 mx-auto my-4 px-6 py-3 font-Josefin font-semibold text-lg"
          >
      ...
      <div className="card relative w-[90%] h-[44rem] border-2 rounded-2xl overflow-hidden shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]">
        ...
        <div className="w-[96%] min-h-fit px-4 flex flex-col gap-4 pt-4">
          ...
          <hr className="relative border-slate-700 border-2" />
          <p className="relative font-Josefin text-lg">
            Think AI, organized by IEEE Computer Society Student Chapter, sought
            to provide exposure in fields of Machine Learning and AI, through
            interactive sessions with speakers and hands- on implementation of
