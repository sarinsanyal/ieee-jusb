...
export default function Chapters() {
  return (
    <div className="py-10 pt-[90px] md:h-[900px] bg-[url('/chapters/chapters-bg.jpg')] dark:bg-[linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.3)),url('/chapters/chapters-bg.jpg')] bg-no-repeat bg-cover font-Josefin">
      {/* HEADER */}
      <h1 className="text-4xl text-sky-950 dark:text-[#38BDF8] text-center font-extrabold">
        STUDENT BRANCH CHAPTERS
      </h1>
      <hr className="w-28 h-1 mx-auto mt-3 bg-sky-950 dark:bg-[#38BDF8] border-0"></hr>
